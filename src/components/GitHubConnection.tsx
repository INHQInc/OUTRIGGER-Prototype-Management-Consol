  ...
  return (
    <div className="rounded-xl border border-border bg-surface overflow-hidden">
      <div className="px-4 py-3 border-b border-border flex items-center justify-between gap-3">
        <div>
          <div className="text-[13px] font-semibold">GitHub connection</div>
          <div className="text-[11px] text-muted-2 mt-0.5">The account this customer&apos;s repos are read through.</div>
        </div>
        {status.connected
